    ...
    return <footer id='footer' className='bg-gray-700 p-32 pb-0 flex flex-col'>
        <div className='flex flex-col w-full'>
            ...
            <div className=' p-2 sm:p-4'>
                <Link href='/privacy-policy' className='text-lg text-white'>Privacy Policy</Link>
            </div>
            <div className=' p-2 sm:p-4'>
                <Link href='/cookies-policy' className='text-lg text-white'>Cookies Policy</Link>
            </div>
            <div className=' p-2 sm:p-4'>
                <Link href='/about-me' className='text-lg text-white'>About me</Link>
            </div>
        </div>
